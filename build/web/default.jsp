<%@page import="es.fecapa.eacta.controller.EActa_controller"%>
...
<!--		    <td><img src="<%= request.getContextPath() %>/LogoFecapa.jpg"></td>
		...
		<br><font style="font-family: verdana;font-size: 10pt;font-style: italic;color: gray;"> Versió 20161028</font>
	</center> 
</body>
</html>